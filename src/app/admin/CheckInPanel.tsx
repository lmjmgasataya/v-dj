              ...
              return (
                ...
                >
                  <div>
                    ...
                    {isCheckedIn && checkIn?.remarks && (
                      <p className="text-xs text-amber-700 mt-0.5 italic">Remarks: {checkIn.remarks}</p>
                    )}
                  </div>
                  {isCheckedIn ? (
                    ...
                    <button
                      ...
                      disabled={pending}
                      className="shrink-0 bg-[#00428E] hover:bg-[#003578] disabled:opacity-50 text-white text-xs font-semibold px-4 py-1.5 rounded-lg transition"
                    >
                      Check In
                    </button>
                  )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-sm p-6 flex flex-col gap-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-0.5">{modalSession.name}</p>
            </div>
            ...
            <div className="flex gap-3 justify-end">
              <button
                onClick={() => { setModalSessionId(null); setRemarks(""); }}
                disabled={pending}
