...
export default async function EditVGLeaderPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "VG Leader Portal", href: "/vg-leader-portal" }, { label: "VG Leaders", href: "/vg-leader-portal/leaders" }, { label: `${leader.lastName}, ${leader.firstName}` }]} />
